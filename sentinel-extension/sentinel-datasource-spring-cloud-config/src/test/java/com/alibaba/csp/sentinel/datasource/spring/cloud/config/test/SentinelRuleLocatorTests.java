...
//        configClientProperties.setUri(new String[]{"http://localhost:8888/scca-config-server/sentinel/dev"});
        configClientProperties.setUri(new String[]{"http://localhost:8888/scca-config-server"});
