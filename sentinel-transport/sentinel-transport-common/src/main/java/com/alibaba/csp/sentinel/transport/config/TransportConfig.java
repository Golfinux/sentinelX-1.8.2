...
public class TransportConfig {
    ...
    public static final String SENTINEL_PROFILE = "csp.sentinel.profile";
    public static final String SENTINEL_LABEL = "csp.sentinel.label";

    public static final String HEARTBEAT_DEFAULT_PATH = "/registry/machine";
    public static final String SENTINEL_DEFAULT_PROFILE = "dev-zt";
    public static final String SENTINEL_DEFAULT_LABEL = "master";
    ...
    public static String getConfigServer(){
        String configServer = SentinelConfig.getConfig(CONFIG_SERVER);
        return configServer;
    }

    public static String getSentinelProfile(){
        String sentinelProfile = SentinelConfig.getConfig(SENTINEL_PROFILE);
        if (StringUtil.isBlank(sentinelProfile)) {
            return SENTINEL_DEFAULT_PROFILE;
        }
        return sentinelProfile;
    }

    public static String getSentinelLabel(){
        String sentinelLabel = SentinelConfig.getConfig(SENTINEL_LABEL);
        if (StringUtil.isBlank(sentinelLabel)) {
            return SENTINEL_DEFAULT_LABEL;
        }
